...
## Project Structure
    ...
    ├── juanshareconnector_1  # Django project configurations
...
1. Clone this repo and `cd juanshareconnector_1`
...
2. Clone this repo and `cd juanshareconnector_1`
