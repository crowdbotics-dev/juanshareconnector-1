"""
Django settings for juanshareconnector_1 project.
...
ROOT_URLCONF = 'juanshareconnector_1.urls'
...
WSGI_APPLICATION = 'juanshareconnector_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanshareconnector_1 API",
    "DESCRIPTION": "API documentation for juanshareconnector_1 App",
    "VERSION": "v1",
}
